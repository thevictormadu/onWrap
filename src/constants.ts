...
export const peakPerformanceIntroduction: string =
  "Every coder has their moment. Here’s when you were truly unstoppable!";
export const peakPerformanceAltIntroduction: string =
...
export const slangIcon: string = "🏆";
export const slangSubtext: string =
  "is how we feel about your coding journey this year";
